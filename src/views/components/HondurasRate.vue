<template>
    <div>
        ...
        <h2 class="main-heading">Compare what account type is best for you</h2>
        ...
        <h2 class="main-heading">Individual Policy</h2>
        <tableVue :list="info.individualTable" :hasHeader="true"/>
